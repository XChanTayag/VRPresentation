...
namespace VRStandardAssets.Utils
{
    ...
    public class UIMovement : MonoBehaviour
    {
        ...
        [SerializeField] private bool m_AlongY;                 // If the user wants to rotate along Y axis
        ...
        private void Start()
        {
            ...
            m_OriginalHeight = m_UIElement.position.y;
        }
        ...
        private void Update()
        {
            ...
            if (m_RotateWithCamera)
            {
                ...
                Vector3 testDirection = m_UIElement.position - m_Camera.position;
                ...
                if(m_AlongY)
                {
                    // targetPosition = testDirection;
                    // float testY = m_DistanceFromCamera * Mathf.Sin(m_Camera.eulerAngles.x);
                    // targetPosition.y = testY;
                    // targetPosition.y = -1.0f * m_Camera.eulerAngles.x;
                }
                else
                {
